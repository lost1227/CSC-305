...
public:
   ...
   // minimax computed value for *brd. *tt will contain new entries for any
   // board configurations that were computed during the call, with depth
   // greater than or equal to SAVE_LEVEL (currently 1), and will have updated
   // any entries for which deeper results were computed during the call.
